...
if __name__ == '__main__':
    ...
    tracker_names = ['TrackerSiamFC']  # 指定跟踪器的名称

    # 设置实验并绘制曲线
    experiment = ExperimentTColor128('/home/adam/Desktop/CoSiNet-main/tools/testdata/Temple-color-128/Temple-color-128',result_dir='tcolor/UDT_Color128')  # 将路径替换为TColor128数据集的路径
    experiment.plot_curves(tracker_names)
